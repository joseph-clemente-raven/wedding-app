...
export default function OurStoryScreen() {
  ...
  return (
    <main className='w-full min-h-screen flex flex-col'>
      <div className='flex flex-col px-0 sm:px-10 pb-32 bg-[#FBFCF8] w-full sm:w-full lg:w-[70%] self-center pt-[70px] sm:pt-[90px]'>
        ...
        <div className='text-center mt-20'>
          <h4 className={`font-bold text-4xl sm:text-6xl ${tangerine.className}`}>
        ...
        <div className='flex flex-col sm:flex-row py-16 px-3 lg:px-10 gap-6'>
          ...
          <div className='flex flex-1 items-center text-center sm:text-right'>
