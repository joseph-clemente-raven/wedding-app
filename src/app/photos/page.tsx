...
export default function PhotoScreen() {
  return (
    <main className='flex flex-col w-full self-center'>
      <div className='flex flex-col gap-2 px-0 mx-auto sm:px-10 w-full lg:w-[70%] min-h-screen bg-[#FBFCF8] pt-28 pb-10'>
        <section className='flex flex-col min-h-[50vh] w-full'>
          ...
          <div className='flex justify-center flex-1 items-center flex-col h-full w-full'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="gray" className='w-20 sm:w-32'>
