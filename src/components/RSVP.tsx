...
export default function RSVP() {
  return (
    <div className='flex items-center flex-col p-0 sm:p-6 gap-4 justify-center'>
      ...
      <p><a target='_blank' href='https://forms.gle/5gpwr7rgj56MY37D7' className='font-bold hover:text-green-900'>Click here to  RSVP</a></p>
    </div>
  )
}
